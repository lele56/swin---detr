...
model = RFDETRBase(
    ...
    pretrain_weights=r"E:\project\麦穗\outputs_tran\checkpoint_best_total.pth",  # 使用训练好的Swin Transformer模型
    num_classes=1,
    resolution=560,
    device='cuda',
    use_ema=True,
    gradient_checkpointing=True,
    class_names=["plant"]  # 确保与训练时一致
)
...
# 创建保存结果的文件夹
output_dir = Path(r'E:\project\麦穗\predict_results_tran')
